...
const CACHE = 'battletees-1783909011';
const CORE = ['./', 'index.html', 'manifest.json', 'icon-180.png', 'icon-512.png', 'crest.jpg', 'banner.jpg', 'wolf.png', 'nine.png', 'vegas.png', 'quota.png'];
